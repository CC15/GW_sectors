...
obj_2048_1 = SampleFile()
obj_2048_1.read_hdf("default_2048_sector9.hdf")
df_2048_1 = obj_2048_1.as_dataframe(True,True,True,False)

obj_2048_2 = SampleFile()
obj_2048_2.read_hdf("default_2048_sector10.hdf")
df_2048_2 = obj_2048_2.as_dataframe(True,True,True,False)

obj_2048_3 = SampleFile()
obj_2048_3.read_hdf("default_2048_sector44.hdf")
df_2048_3 = obj_2048_3.as_dataframe(True,True,True,False)

obj_2048_4 = SampleFile()
obj_2048_4.read_hdf("default_2048_sector45.hdf")
df_2048_4 = obj_2048_4.as_dataframe(True,True,True,False)

#obj_extra = SampleFile()
#obj_extra.read_hdf("default_NS_snr-30-35.hdf")
#df_extra = obj_extra.as_dataframe(True,True,True,False)

obj_test = SampleFile()
obj_test.read_hdf("default_GW150914.hdf")
df_test = obj_test.as_dataframe(True,True,True,False)

#obj_test_1 = SampleFile()
#obj_test_1.read_hdf("default_GW170817_new_snr-50.hdf")
#df_test_1 = obj_test_1.as_dataframe(True,True,True,False)

df = pd.concat([df1, df_2048_1, df_2048_2, df_2048_3, df_2048_4, df_test], ignore_index= True)
...
#df_1 = {"H1-L1 Time lag": h1l1_time, "L1-V1 Time lag": l1v1_time, "H1-V1 Time lag": h1v1_time, "H1-L1 Time Hilbert": h1l1_time_h, "L1-V1 Time Hilbert": l1v1_time_h, "H1-V1 Time Hilbert": h1v1_time_h, "Sector": label}
...
np.savetxt("Predictions_GW150914_pure_signal.txt", np.transpose(y_pred_test))
