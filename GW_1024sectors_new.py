...
#obj_test1 = SampleFile()
#obj_test1.read_hdf("default_GW150914.hdf")
#df_test1 = obj_test1.as_dataframe(True,True,True,False) #creating the dataframe from the hdf file


#obj_test1 = SampleFile()
#obj_test1.read_hdf("default_event2_snr10.hdf")
#df_test1 = obj_test1.as_dataframe(True,True,True,False)

#obj_test2 = SampleFile()
#obj_test2.read_hdf("default_event2_snr15.hdf")
#df_test2 = obj_test2.as_dataframe(True,True,True,False)

#obj_test3 = SampleFile()
#obj_test3.read_hdf("default_event2_snr20.hdf")
#df_test3 = obj_test3.as_dataframe(True,True,True,False)

#obj_test4 = SampleFile()
#obj_test4.read_hdf("default_event2_snr25.hdf")
#df_test4 = obj_test4.as_dataframe(True,True,True,False)

#obj_test5 = SampleFile()
#obj_test5.read_hdf("default_event2_snr30.hdf")
#df_test5 = obj_test5.as_dataframe(True,True,True,False)

#obj_test6 = SampleFile()
#obj_test6.read_hdf("default_event2_snr35.hdf")
#df_test6 = obj_test6.as_dataframe(True,True,True,False)

#obj_test7 = SampleFile()
#obj_test7.read_hdf("default_event2_snr40.hdf")
#df_test7 = obj_test7.as_dataframe(True,True,True,False)

#obj_test8 = SampleFile()
#obj_test8.read_hdf("default_event2_snr45.hdf")
#df_test8 = obj_test8.as_dataframe(True,True,True,False)

#obj_test1 = SampleFile()
#obj_test1.read_hdf("default_GW150914_snr-10.hdf")
#df_test1 = obj_test1.as_dataframe(True,True,True,False)

#obj_test2 = SampleFile()
#obj_test2.read_hdf("default_GW150914_snr-15.hdf")
#df_test2 = obj_test2.as_dataframe(True,True,True,False)

#obj_test3 = SampleFile()
#obj_test3.read_hdf("default_GW150914_snr-20.hdf")
#df_test3 = obj_test3.as_dataframe(True,True,True,False)

#obj_test4 = SampleFile()
#obj_test4.read_hdf("default_GW150914_snr-25.hdf")
#df_test4 = obj_test4.as_dataframe(True,True,True,False)

#obj_test5 = SampleFile()
#obj_test5.read_hdf("default_GW150914_snr-30.hdf")
#df_test5 = obj_test5.as_dataframe(True,True,True,False)



#obj_test9 = SampleFile()
#obj_test9.read_hdf("default_2048_sector9.hdf")
#df_test9 = obj_test9.as_dataframe(True,True,True,False)

#obj_test10 = SampleFile()
#obj_test10.read_hdf("default_2048_sector10.hdf")
#df_test10 = obj_test10.as_dataframe(True,True,True,False)

#obj_test11 = SampleFile()
#obj_test11.read_hdf("default_2048_sector44.hdf")
#df_test11 = obj_test11.as_dataframe(True,True,True,False)

#obj_test12 = SampleFile()
#obj_test12.read_hdf("default_2048_sector45.hdf")
#df_test12 = obj_test12.as_dataframe(True,True,True,False)
...
#df = pd.concat([df1, df_test9, df_test10, df_test11, df_test12], ignore_index= True)
...
classifier.add(Dense(units = 4035, kernel_initializer = 'uniform'))
classifier.add(BatchNormalization())
...
#np.savetxt('Preds2048_event-2_SNR-10.txt', y_pred_test[0])
#np.savetxt('Preds2048_event-2_SNR-15.txt', y_pred_test[1])
#np.savetxt('Preds2048_event-2_SNR-20.txt', y_pred_test[2])
#np.savetxt('Preds2048_event-2_SNR-25.txt', y_pred_test[3])
#np.savetxt('Preds2048_event-2_SNR-30.txt', y_pred_test[4])
#np.savetxt('Preds2048_event-2_SNR-35.txt', y_pred_test[5])
#np.savetxt('Preds2048_event-2_SNR-40.txt', y_pred_test[6])
#np.savetxt('Preds2048_event-2_SNR-45.txt', y_pred_test[7])
        
#np.savetxt('Predictions_2048_GW150914_snr-10.txt', np.transpose(y_pred_test[0]))
#np.savetxt('Predictions_2048_GW150914_snr-15.txt', np.transpose(y_pred_test[1])) 
#np.savetxt('Predictions_2048_GW150914_snr-20.txt', np.transpose(y_pred_test[2])) 
#np.savetxt('Predictions_2048_GW150914_snr-25.txt', np.transpose(y_pred_test[3])) 
#np.savetxt('Predictions_2048_GW150914_snr-30.txt', np.transpose(y_pred_test[4])) 
